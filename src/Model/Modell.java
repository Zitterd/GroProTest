...
public class Modell implements IModell
{
	 ...
	 * @param feld Übergeben wird die Startverteilung
	 */
	...
	/**
	 * Diese Methode prüft ob das Spiel zuende ist, also ob alle Feldinhalte des Arrays
	 * gleich 0 sind.
	...
	//zug wird notiert
	/**
	 * Diese Methode notiert den letzt gespielten Zug, um alle Züge zu speichern in einem Spiel.
	 * @param zug Int Array für den gespielten Zug
	 */
	...
	/**
	 * Enthält den ersten Sieg von Spieler 1 wenn vorhanden.
	 * @return Zweidimensionales Array mit den gespeicherten Zügen.
	 */
	public int[][] getfeld1()
	{
		return erstersieg1;
	...
	/**
	 * Enthält den ersten Sieg von Spieler 2 wenn vorhanden.
	 * @return Zweidimensionales Array mit den gespeicherten Zügen.
	 */
	public int[][] getfeld2()
	{
	...
	//Aktuelle Verteilung
	/**
	 * Gibt die aktuelle Spielststellung zurück.
	 * @return rueckgabe Eindimensionales Array für das gegebene Spielfeld.
	 */
