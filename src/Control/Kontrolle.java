...
public class Kontrolle implements IControl 
{
	...
	/**
	 * @param pfad Der Dateiname der einzulesenen Datei.
	 */
	public Kontrolle(String pfad)
	{
		...
		try {
			...
			e.printStackTrace();
			einAus.fehlerAusgabe();
		}
	}
	

	/**
	 * Diese Methode simuliert 10 Spiele mit den Spielstrategien für Spieler 1 und Spieler 2.
	 */
